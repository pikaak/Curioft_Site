  ...
  <footer className="site-footer">
    <div className="container footer-container">
      ...
      <p className="footer-sub">
        타로, 게임, 편의성 툴 등을 만들고 무료 제공하는 1인 웹스튜디오
      </p>
    </div>
  </footer>
);
          ...
          <div className="container legal-page">
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>사용자가 직접 업로드한 이미지와 명칭</li>
                  <li>설문 폼 등에 사용자가 직접 작성한 응답</li>
                </ul>
              </li>
            </ul>

            <h2>2. 개인정보의 이용 목적</h2>
            <p>서비스는 수집된 정보를 다음의 목적 범위에 한해서만 사용합니다.</p>
            <ul>
              <li>서비스 구현을 위한 필수 기능 유지</li>
              <li>오류/버그 확인 및 보안 사고 대응</li>
              <li>서비스 품질 보완을 위한 통계 분석</li>
            </ul>

            <h2>3. 보관 및 파기</h2>
            <ul>
              <li>법령에 특별한 규정이 없는 한, 서비스 이용 기록은 통계적 목적을 위해 일정 기간 보관될 수 있습니다.</li>
              <li>보관 목적이 없어질 경우, 지체 없이 해당 정보를 삭제하거나 비식별화합니다.</li>
            ...
            <p className="legal-disclaimer">
              ...
              중요한 변경 사항이 있을 경우 가능한 한 명확하게 공지하도록 하겠습니다.
            </p>
          </div>
        </section>
      </main>
