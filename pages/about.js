      ...
      <main className="site-main">
        <section className="section section-light">
          <div className="container legal-page">
            ...
            <p className="legal-note">
              기술이 발전하면서 흥미를 위한 선택지도 많아졌지만, 그럴수록 우리는 스스로를 돌아보며 쉬어갈 틈을 잃고 있습니다. <br/>
              Curioft는 이러한 흐름 속에서 “작지만 의미 있는 경험”을 최대한 많은 이들에게 안겨주는 것을 목표로 합니다. <br/> 
              <br/> 내 고양이에 대해 항상 궁금한 집사들을 위한 타로 리딩,
              정서적으로 교감할 수 있는 나만의 스피릿 애니멀, 그리고 가족과 함께 즐길 수 있는 교육 콘텐츠 등... 
              <br/> 단순한 흥미를 넘어 현대인의 영혼을 소소하게나마 치유할 수 있는 다양한 실험을 진행하고 있습니다.
            </p>

            <p>
              Curioft가 추구하는 방향은 거대한 플랫폼 구축이나 복잡하고 팬시한 상업적 툴 같은 것이 아닙니다. 
              모바일로 편하게 드나들 수 있는 무료 웹 놀이터, 간편하지만 기억에 남는 순간에 대한 대명사로 누군가에게는 남을 수 있기를 꿈꿉니다.
            </p>
            {/* ---- 확장된 본문 추가 끝 ---- */}
            ...
            <p>
              ...
              아이가 이해하기 어려운 의학적 개념을 내 몸 안의 백혈구가 되어 체험해보는 형태로 풀어낸 2D 게임, 
            ...
            <p>
              ...
              사용자가 웹 페이지를 열자마자 바로 이용할 수 있으며, 개인정보에 대한 부담 없이 간단하게 즐길 수
